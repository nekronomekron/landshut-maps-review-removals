...
func makeChart(rows []mapsreview.Place, scope string, args args) string {
	...
	if scope != "overall" {
		title = "Postleitzahl " + scope + " — Landshut"
